...
authors:
  ...
  - name: Nicole Santos
    linkedin:
figma_embed: '<iframe class="project_preview" src="https://embed.figma.com/proto/akkrVf6t7372bq0Xi7TsKY/Lumiar?node-id=815-451&p=f&viewport=-733%2C155%2C0.17&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=815%3A451&page-id=0%3A1&embed-host=share" allowfullscreen></iframe>'
